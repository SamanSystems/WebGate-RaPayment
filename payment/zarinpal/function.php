...
function send_to_bank($Amount,$CallbackURL,$Email,$Mobile,$config,$subject,$lang)
{
	...
	if($result1 == 100)
	{
		...
		$show['Post_url'] ='https://www.zarinpal.com/pg/StartPay/'.$result->Authority;
		$show['input_fild'][] = 'Test_name|value of thei fild for send to bank' ;
		$show['input_fild'][] = 'Test2_name|value of thei fild for send to bank' ;
		$show['trans_id1'] = '' ;
